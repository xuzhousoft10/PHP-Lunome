...
MediaIndex._getHistory = function() {
    var history = $.cookie('search-condition-did');
...
MediaIndex._updateHistory = function() {
    ...
    $.cookie('search-condition-did',JSON.stringify(history),{ expires:1});
};
...
MediaIndex._InsertMediaIntoContainer = function( media, sign ) {
    ...
    var coverContainer = $('<div>')
        ...
        .mouseenter(function() {
            var intro = $(this).children('.lnm-media-list-item-intro-area');
            intro.html(intro.attr('data-content'));
        })
        .mouseleave(function() {
            $(this).children('.lnm-media-list-item-intro-area').html('');
        })
        .appendTo(itemContainer);
    var introContainer = $('<div>')
        .attr('data-content', media.introduction)
    ...
    var markContainer = $('<div>')
        .attr('class', 'btn-group btn-group-justified lnm-media-list-item-mark-container-show')
        .appendTo(coverContainer)
    for ( var markCode in this.marks ) {
        ...
        }, media, sign).appendTo(markContainer);
    }
 ...
 * @returns jQuery
 */
MediaIndex._generateMarkButton = function(mark, media, sign) {
    var container = $('<div>')
    .append($('<div>')
