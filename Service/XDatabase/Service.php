...
class Service extends \X\Core\Service\XService {
    ...
    public function getDatabase( $name=null ) {
        ...
        $this->checkIfDbExistsByName($name);
     ...
     * @return boolean
     */
    public function hasDatabase( $name=self::DEFAULT_DB_NAME ) {
     ...
     */
    protected function checkIfDbExistsByName( $name ) {
        if ( !$this->hasDatabase($name) ) {
            throw new Exception("Can not find \"$name\" in DB manager.");
        }
    }
}