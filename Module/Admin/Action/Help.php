 ...
 * @author michael
 */
class Help extends \X\Service\XAction\Core\Action {
    public function runAction( Console $console, $parameters ) {
        ...
        case 'module' :
            ...
            break;
        default:
            $docPath = X::system()->getPath('Module/Admin/Document/SettingHelp.txt');
            $console->printString(file_get_contents($docPath));
            $console->printLine('');
            return;
        }
