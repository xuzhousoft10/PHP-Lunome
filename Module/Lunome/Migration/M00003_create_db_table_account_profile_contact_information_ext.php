...
/** 
 * M00003_create_db_table_account_profile_contact_information_ext 
 */
class M00003_create_db_table_account_profile_contact_information_ext extends \X\Core\Module\Migrate {
    /** 
     * (non-PHPdoc)
    ...
    public function up() {
        ...
        $columns[] = Column::create('account')->setType(ColumnType::T_VARCHAR)->setLength(45)->setNullable(false);
