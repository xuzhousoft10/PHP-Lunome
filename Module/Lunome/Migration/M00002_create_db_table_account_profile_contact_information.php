...
/** 
 * M00002_create_db_table_account_profile_contact_information 
 */
class M00002_create_db_table_account_profile_contact_information extends \X\Core\Module\Migrate {
    /** 
     * (non-PHPdoc)
