<?php
/** 
 * Migration file for create_db_table_account_profile_contact_place_regions 
 */
...
/** 
 * M00004_create_db_table_account_profile_contact_place_regions 
 */
class M00004_create_db_table_account_profile_contact_place_regions extends \X\Core\Module\Migrate {
    /** 
     * (non-PHPdoc)
    ...
    public function down() {
        TableManager::open('account_profile_contact_place_regions')->drop();
    }
}