...
/** 
 * M00009_create_db_table_account_profile_living_place_regions 
 */
class M00009_create_db_table_account_profile_living_place_regions extends \X\Core\Module\Migrate {
    /** 
     * (non-PHPdoc)
    ...
    public function up() {
        ...
        $columns[] = Column::create('level')->setType(Column::T_SMALLINT)->unsigned()->notNull();
